...
public class TestCubeMetastoreClient {
  ...
  public void testDimension() throws Exception {
    ...
    Dimension toAlter = new Dimension(tbl);
      toAlter.alterAttribute(new BaseDimAttribute(new FieldSchema("newZipDim", "int", "new dim added"), null, null, null, null, 1000L));
    ...
    Assert.assertEquals(((BaseDimAttribute) newzipdim).getType(), "int");
      Assert.assertEquals((((BaseDimAttribute) newzipdim).getNumOfDistinctValues()).longValue(), (long)1000);
