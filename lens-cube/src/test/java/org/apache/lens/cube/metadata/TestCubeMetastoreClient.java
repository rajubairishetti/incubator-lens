...
public class TestCubeMetastoreClient {
  ...
  private static void defineCube(String cubeName, String cubeNameWithProps, String derivedCubeName,
    ...
    locationHierarchyWithStartTime.add(new ReferencedDimAtrribute(new FieldSchema("zipcode2", "int", "zip"),
        "Zip refer2", new TableReference("zipdim", "zipcode"), now, now, 100.0, true, 1000));
  ...
  public void testDimension() throws Exception {
    ...
    toAlter.alterAttribute(new BaseDimAttribute(new FieldSchema("newZipDim", "int", "new dim added"), null, null, null, null, 1000));
    ...
    Assert.assertEquals(((BaseDimAttribute) newzipdim).getNumOfDistinctValues(), 1000);
